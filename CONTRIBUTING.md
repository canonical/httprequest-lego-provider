...
This document explains the processes and practices recommended for contributing enhancements to the HTTP request Lego provider Operator.

## Overview

- Generally, before developing enhancements to this charm, you should consider [opening an issue
  ](https://github.com/canonical/httprequest-lego-provider/issues) explaining your use case.
...
- [Fork](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/about-forks)
  our [GitHub repository](https://github.com/canonical/httprequest-lego-provider)
...
Canonical welcomes contributions to the HTTP request Lego provider Operator. Please check out our
...
```
git clone https://github.com/canonical/httprequest-lego-provider
```
...
OCI image for the HTTP request Lego provider app, and then upload the image to a MicroK8s registry,
...
# Deploy the charm
juju deploy ./httprequest-lego-provider*.charm 
```
